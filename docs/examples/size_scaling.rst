...
.. code-block:: bash
   ...
   python -m pymembrane.examples.size_scaling --subdivisions 0 1 2 3 --steps 100 --json size_scaling.json
...
smoke-test length of 10 steps for the Monte Carlo and Brownian dynamics
workflows.
