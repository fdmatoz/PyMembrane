 ...
 *  @brief Handles Fast Inertial Relaxation Engine (FIRE) algorithm for minimizing energy.
 * 
 *  This is essentially a molecular dynamics technique 
 *  to seek minima allegedly far superior to the conjugate
 *  gradient minimization techniques. 
 * 
 *  @details Implementation follows  Bitzek, et al., PRL, 2006.
 */
