...
/**
This code was initially written by Dr. Siyu Li 2020. As 2023, the code needs to be updated to the latest version of the code.
ToDo:
1. Simplify the code
2. Find new ways to compute the quantities
 */
