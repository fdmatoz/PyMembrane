 ...
 * @brief ComputeVertexBendingHelfrichEnergy Compute the Seung-Nelson Bending Energy/Force
 */
...
public:
  ...
  {
    m_name = "BendingGK"; //!< potential name
...
private:
  ...
  pymemb::vector<double> m_kappaG;  //!< bending rigidity
};
